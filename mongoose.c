...
static void mg_send_directory_listing(struct mg_connection *nc, const char *dir,
  ...
  mg_printf_http_chunk(
	  ...
	  "<style>* {padding:0;margin:0 auto;}body {color: #333;font: 14px Sans-Serif;padding: 50px;background: #eee;}h1 {font-size: 18px;text-align: left;padding: 15px 15px 0 15px;margin: 0;}#path {font-size: 18px;text-align: left;margin: 0;color: #FE4902;}#container {box-shadow: 0 5px 10px -5px rgba(0,0,0,0.5);position: relative;background: white;width: 700px;}table {background-color: #F3F3F3;border-collapse: collapse;margin: 15px 0;width: 700px;}th {background-color: #FE4902;color: #FFF;cursor: pointer;padding: 5px 10px;}th small {font-size: 9px;}td, th {text-align: left;}a {text-decoration: none;}td a {color: #663300;display: block;padding: 5px 10px;}th a {padding-left: 0;}td:first-of-type a {background: url('data:image/png;base64,') no-repeat 10px 50; padding-left: 15px;}th:first-of-type {padding-left: 35px;}td:not(:first-of-type) a {background-image: none !important;} tr:nth-of-type(odd) {background-color: #E6E6E6;}tr:hover td {background-color:#CACACA;}tr:hover td a {color: #000;}td {max-width: 300px;overflow: hidden;text-overflow: ellipsis;white-space: nowrap;padding: 0 15px 0 0 ;}</style>"
	  "</head>\n"
	  "<body><div id=container><h1>Directory:<a id=path>%.*s</a></h1>\n<table class=sortable><thead><tr><th>Filename</th><th>Modified</th><th>Size <small>(bytes)</small></th></tr>\n</thead>"
	  "<tbody>",
